...
function myModal2(id)
{
  ...
  if(id==8)
  {
    ...
    $("#model_foot2").html("&nbsp;&nbsp;&nbsp;&nbsp;天贝物联网产品依托LORA、NB-loT、RFID、LTE、zigbee、蓝牙技术、为用户提供智能家居、远程抄表、智慧医院、智能停车、智能头盔、智慧公寓方案、同时提供物联网模块的开发。");
  }
}
function s1(id){
    if(id==1)
    ...
    if(id==7)
    {
       ...
       $("#model_foot").html("&nbsp;&nbsp;&nbsp;&nbsp;天贝物联网产品依托LORA、NB-loT、RFID、LTE、zigbee、蓝牙技术、为用户提供智能家居、远程抄表、智慧医院、智能停车、智能头盔、智慧公寓方案、同时提供物联网模块的开发。");
    }
    if(id==8)
    {
       $('#img_yan').css('display','none'); 
